...
#sq-announce{
  ...
  pointer-events:none;padding-top:56px;
}
.sq-msg{
  background:rgba(0,0,0,.88);backdrop-filter:blur(12px);
  border:1px solid rgba(232,0,42,.3);border-radius:12px;
  padding:10px 20px;margin-bottom:8px;max-width:92vw;
  font-family:'Black Han Sans','Noto Sans KR',sans-serif;
  font-size:.88rem;letter-spacing:.06em;color:#f0ece8;
...
`;
  ...
  function redLightEffect() {
    ...
    shake(250);
    vibrate([60, 40, 80]);
    announce('🔴', { type: 'danger', duration: 1000 });
  }
